          ...
          <div className="mx-auto max-w-[1240px] px-[clamp(20px,4vw,56px)]">
            <div className="mx-auto max-w-[820px]">
              ...
              <P className="mt-4 text-[16px] leading-[1.7] text-[#4F6172]">
                This short pipe run means less labour, fewer materials, and a cleaner finish with no
                exposed pipework running along the outside of your house. It is the quickest install
                to complete and the easiest on the wallet.
              </P>
              <P className="mt-4 text-[16px] leading-[1.7] text-[#4F6172]">
