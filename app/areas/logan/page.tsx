...
export const metadata: Metadata = {
  title: 'Electrician Logan — Links Air & Electrical',
  description:
    'Electricians and air conditioning services across Logan. Springwood, Beenleigh, Browns Plains and surrounds. Call 1300 010 393.',
  alternates: {
    canonical: `${siteConfig.url}/areas/logan`,
  },
  openGraph: {
    title: 'Electrician Logan — Links Air & Electrical',
    description:
      'Electricians and air conditioning services across Logan. Springwood, Beenleigh, Browns Plains and surrounds. Call 1300 010 393.',
    url: `${siteConfig.url}/areas/logan`,
  },
};
    ...
    <>
      ...
      <main>
        ...
        <section className="bg-white py-[clamp(72px,9vw,120px)]">
          <div className="mx-auto max-w-[820px] px-[clamp(20px,4vw,56px)] text-center">
            ...
            >
              Reliable Electricians in Logan
            </Heading>
            <P className="mt-5 text-[17px] leading-[1.7] text-[#4F6172]">
              Links Air &amp; Electrical provides fast, reliable electrical and air conditioning
              services across the Logan region. From Logan Central and Springwood through to
              Beenleigh, Browns Plains, and surrounding suburbs, our licensed team is ready to help.
            </P>
            <P className="mt-4 text-[16px] leading-[1.7] text-[#4F6172]">
              We handle everything from residential repairs and switchboard upgrades to commercial
              fit-outs and split system installations — all with upfront pricing and quality
              workmanship.
            </P>
          </div>
        </section>
        ...
        <section className="bg-[#F4F7FA] py-[clamp(48px,6vw,80px)]">
          <div className="mx-auto max-w-[820px] px-[clamp(20px,4vw,56px)] text-center">
            ...
            <P className="mt-4 text-[18px] leading-[1.7] font-medium text-[#0E1B2C]">
              Need an electrician in Logan? Call us on{' '}
              <Link
      ...
      <JsonLd
        data={{
          ...
          '@type': 'Service',
          name: 'Electrician & Air Conditioning Logan',
          description: 'Electricians and air conditioning services across Logan.',
          url: `${siteConfig.url}/areas/logan`,
          provider: {
            '@type': 'LocalBusiness',
