...
export const metadata: Metadata = {
  title: 'Electrician Ipswich — Links Air & Electrical',
  description:
    'Licensed electricians and air conditioning specialists in Ipswich, Springfield, and surrounds. Call 1300 010 393.',
  alternates: {
    canonical: `${siteConfig.url}/areas/ipswich`,
  },
  openGraph: {
    title: 'Electrician Ipswich — Links Air & Electrical',
    description:
      'Licensed electricians and air conditioning specialists in Ipswich, Springfield, and surrounds. Call 1300 010 393.',
    url: `${siteConfig.url}/areas/ipswich`,
  },
};
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          eyebrow="Ipswich"
          title="Electrician & Air Conditioning Ipswich"
          image="/images/services/banner-hero.webp"
          imageAlt="Licensed electrician servicing Ipswich homes and businesses"
        />
        ...
        <section className="bg-white py-[clamp(72px,9vw,120px)]">
          <div className="mx-auto max-w-[820px] px-[clamp(20px,4vw,56px)] text-center">
            ...
            >
              Your Ipswich Electrical Specialists
            </Heading>
            <P className="mt-5 text-[17px] leading-[1.7] text-[#4F6172]">
              Links Air &amp; Electrical services the wider Ipswich region including Springfield,
              Goodna, Redbank Plains, and surrounding suburbs. Our licensed electricians deliver
              reliable residential and commercial electrical work alongside full air conditioning
              services.
            </P>
            <P className="mt-4 text-[16px] leading-[1.7] text-[#4F6172]">
              From new home wiring in Springfield Lakes to switchboard upgrades in central Ipswich,
              we bring fast response times, transparent pricing, and a commitment to quality on
              every job.
            </P>
          </div>
        </section>
        ...
        <section className="bg-[#F4F7FA] py-[clamp(48px,6vw,80px)]">
          <div className="mx-auto max-w-[820px] px-[clamp(20px,4vw,56px)] text-center">
            ...
            <P className="mt-4 text-[18px] leading-[1.7] font-medium text-[#0E1B2C]">
              Need an electrician in Ipswich? Call us on{' '}
              <Link
      ...
      <JsonLd
        data={{
          ...
          '@type': 'Service',
          name: 'Electrician & Air Conditioning Ipswich',
          description:
            'Licensed electricians and air conditioning specialists in Ipswich, Springfield, and surrounds.',
          url: `${siteConfig.url}/areas/ipswich`,
          provider: {
            '@type': 'LocalBusiness',
