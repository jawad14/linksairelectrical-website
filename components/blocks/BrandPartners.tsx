...
const brands = [
  ...
  { src: '/images/brands/fujitsu.png', alt: 'Fujitsu', width: 120, height: 40 },
  { src: '/images/brands/panasonic.jpg', alt: 'Panasonic', width: 120, height: 40 },
  { src: '/images/brands/actronair.png', alt: 'ActronAir', width: 120, height: 40 },
