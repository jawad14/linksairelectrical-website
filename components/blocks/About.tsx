          ...
          <div className="flex flex-col items-center gap-6 text-center md:flex-row md:justify-between md:text-left">
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              <a
                ...
                className="bg-accent inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-base font-bold text-white transition-opacity hover:opacity-90"
              >
              ...
              <Link
                href="/contact"
                className="border-primary-foreground/30 text-primary-foreground hover:border-primary-foreground/60 inline-flex items-center rounded-full border-2 px-7 py-3.5 text-sm font-bold transition-colors"
              >
                Request a Quote
              </Link>
            </div>
